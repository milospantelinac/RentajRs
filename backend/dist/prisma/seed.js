...
const CATEGORY_TREE = [
    ...
    },
    {
        ...
        attributes: [
            ...
            { key: 'tezina_masine', name: 'Težina mašine', type: client_1.AttributeType.NUMBER, unit: 'kg' },
            { key: 'snaga_motora', name: 'Snaga motora', type: client_1.AttributeType.NUMBER, unit: 'kW' },
            ...
            { key: 'max_dubina_kopanja', name: 'Maksimalna dubina kopanja', type: client_1.AttributeType.NUMBER, unit: 'm', dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'bager' },
            { key: 'max_radna_visina_bager', name: 'Maksimalna radna visina', type: client_1.AttributeType.NUMBER, unit: 'm', dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'bager' },
            { key: 'zapremina_kasike', name: 'Zapremina kašike', type: client_1.AttributeType.NUMBER, unit: 'm³', dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'bager' },
            ...
            { key: 'nosivost_dizalica', name: 'Nosivost', type: client_1.AttributeType.NUMBER, unit: 'kg', required: true, showOnCard: true, dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'dizalica-kran' },
            { key: 'max_visina_dizanja_dizalica', name: 'Maksimalna visina dizanja', type: client_1.AttributeType.NUMBER, unit: 'm', required: true, showOnCard: true, dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'dizalica-kran' },
            { key: 'horizontalni_domet', name: 'Horizontalni domet', type: client_1.AttributeType.NUMBER, unit: 'm', dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'dizalica-kran' },
            ...
            { key: 'max_radna_visina_platforma', name: 'Maksimalna radna visina', type: client_1.AttributeType.NUMBER, unit: 'm', required: true, showOnCard: true, dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'platforma-za-rad-na-visini' },
            { key: 'nosivost_platforma', name: 'Nosivost', type: client_1.AttributeType.NUMBER, unit: 'kg', required: true, showOnCard: true, dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'platforma-za-rad-na-visini' },
            ...
            { key: 'radni_domet_platforma', name: 'Radni domet', type: client_1.AttributeType.NUMBER, unit: 'm', dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'platforma-za-rad-na-visini' },
            ...
            { key: 'nosivost_transporter', name: 'Nosivost', type: client_1.AttributeType.NUMBER, unit: 'kg', required: true, showOnCard: true, dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'transporter-mini-damper' },
            { key: 'zapremina_korpe', name: 'Zapremina korpe', type: client_1.AttributeType.NUMBER, unit: 'm³', showOnCard: true, dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'transporter-mini-damper' },
            { key: 'visina_istovara', name: 'Visina istovara', type: client_1.AttributeType.NUMBER, unit: 'm', dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'transporter-mini-damper' },
            ...
            { key: 'nosivost_viljuskar', name: 'Nosivost', type: client_1.AttributeType.NUMBER, unit: 'kg', required: true, showOnCard: true, dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'viljuskar' },
            { key: 'max_visina_dizanja_viljuskar', name: 'Maksimalna visina dizanja', type: client_1.AttributeType.NUMBER, unit: 'm', required: true, showOnCard: true, dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'viljuskar' },
            ...
            { key: 'radni_domet_viljuskar', name: 'Radni domet', type: client_1.AttributeType.NUMBER, unit: 'm', dependsOnAttrKey: 'tip_masine', dependsOnOptionKey: 'viljuskar' },
        ],
    },
    {
        ...
        attributes: [
            { key: 'povrsina', name: 'Površina', type: client_1.AttributeType.NUMBER, unit: 'm²', required: true, showOnCard: true },
            { key: 'visina_prostora', name: 'Visina prostora', type: client_1.AttributeType.NUMBER, unit: 'm', required: true, showOnCard: true },
